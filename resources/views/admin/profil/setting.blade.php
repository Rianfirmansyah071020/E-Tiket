...
@section('content')
    <form action="/admin/dashboard/profil/setting/{{ $data->id }}/{{ $data->email }}" method="post"
        enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row card shadow p-4">
            <h5>Setting data admin <span class="text-info">{{ $data->nama }}</span></h5>
            <hr>
            <div class="d-lg-flex d-xl-flex justify-content-center">
                <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12 m-1  d-lg-flex justify-content-center">
                    <div class="card">
                        <img src="/storage/admin/{{ $data->gambar }}" alt="{{ $data->gambar }}"
                ...
                <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12 m-1">
                    ...
                    <div class="mt-4 d-flex justify-content-end">
                        <a href="/admin/dashboard/profil/{{ $data->id }}" class="btn btn-success mr-1">kembali</a>
